...
export default class CameraControls extends EventDispatcher {
  ...
  constructor(object, domElement, _options = {}) {
    ...
    if (!this.domElement || options.ignoreDOMEventListeners) {
      ...
      options.keepMousedownListener && this.domElement.addEventListener('mousedown', onMouseDown)
      options.keepTouchstartListener && this.domElement.addEventListener('touchstart', onTouchStart)
      options.keepWheelListener && this.domElement.addEventListener('wheel', onMouseWheel)
      options.keepContextmenuListener && this.domElement.addEventListener('contextmenu', onContextMenu)
